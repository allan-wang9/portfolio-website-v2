// Source: https://sketchfab.com/3d-models/space-girl-d9d07d4be7e74c6585cf62a1888d8d53

import React from 'react'
import { useGLTF } from '@react-three/drei'

export function SpaceGirl(props) {
    const { nodes, materials } = useGLTF('/models/space_girl.glb')
    return (
...
useGLTF.preload('/models/space_girl.glb')
